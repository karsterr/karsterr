...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=2E9EF7&center=true&vCenter=true&width=600&lines=Information+Systems+Professional;Data+%26+Systems+Architecture;Multidisciplinary+IT+Solutions;Building+the+future%2C+one+commit+at+a+time" alt="Typing SVG" />
...
🔬 **As a Data Specialist** — Extracting actionable insights from complex datasets using MATLAB and Python (ML, NLP, Pandas).

⚙️ **As a System Architect & Poweruser** — Architecting and optimizing infrastructure with Linux (Arch/Debian environments), Bash, Docker, and C++ to ensure maximum performance. I am deeply passionate about open-source technologies and hardware/software integration.
...
## 🌱 Currently Exploring
  ...
  - Automating design and rendering pipelines (Python + CAD/3D Tools)
